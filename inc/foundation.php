 ...
 */
if ( ! function_exists( 'zurb_foundation_active_nav_class' ) ) {
	function zurb_foundation_active_nav_class( $classes, $item ) {
...
add_filter( 'nav_menu_css_class', 'zurb_foundation_active_nav_class', 10, 2 );

/**
 * Use the active class of ZURB Foundation on wp_list_pages output.
 * From required+ Foundation http://themes.required.ch
 */
if ( ! function_exists( 'zurb_foundation_active_list_pages_class' ) ) {
	function zurb_foundation_active_list_pages_class( $input ) {
...
add_filter( 'wp_list_pages', 'zurb_foundation_active_list_pages_class', 10, 2 );
